const { country } = require("@/locale/translation/en_us");
...
exports.migrate = (client) => {
  ...
  return {
    ...
    weight:mergedHealthParams.weight,
    height:mergedHealthParams.height,
    healthParams: mergedHealthParams,
    nameContactEmergency: mergedEmergencyContact.name, 
    phoneContactEmergency: mergedEmergencyContact.phone,
    relationshipContactEmergency: mergedEmergencyContact.relationship,
